...
export default function InfoEachDepartment() {
  ...
  const fetchCurrentSemester = async () => {
    try {
      ...
      // إضافة alert لعرض رسالة الخطأ من الـ API
  ...
  const fetchCourses = async () => {
    ...
    try {
      console.log("semesterId used:", semesterId); // لمجرد التأكد
  ...
  // أول useEffect: جيب الـ semesterId و الإحصائيات
  useEffect(() => {
  ...
  // ثاني useEffect: لما semesterId يتغير، جيب الكورسات
  useEffect(() => {
    if (semesterId) {
      fetchCourses();
    }
