    ...
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          ...
          previousCourse:
            response.data.result.previousCourse || "Not Available",
        });
      } catch (error) {
        if (error.response) {
          setError(
    ...
    <>
      <div className={styles.personalInfoContainer}>
        ...
        <div className={styles.row}>
          ...
          <span className={styles.data}>{courseData.previousCourse}</span>
        </div>
      </div>
    </>
  );
