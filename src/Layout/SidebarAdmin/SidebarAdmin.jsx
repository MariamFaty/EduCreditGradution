...
import SidebarAdminStyle from "./SidebarAdmin.module.css";
...
export default function SidebarAdmin() {
  ...
  return (
    <>
      ...
      <div className={SidebarAdminStyle.container}>
        {/* Sidebar */}
        <div
          className={` ${SidebarAdminStyle.sidebar}  ${
            isSidebarOpen
              ? "translate-x-0"
        ...
        >
          <div className={SidebarAdminStyle.logo}>{sideLogo}</div>
          <div className={SidebarAdminStyle.line}></div>
          <h3 className={SidebarAdminStyle.menuTitle}>MAIN MENU</h3>
          <ul className={SidebarAdminStyle.menu}>
            <li>
              <NavLink to="/AdminRole">
                <i className="fa-solid fa-chart-pie"></i> <p>Dashboard</p>
              </NavLink>
            </li>
            <li>
              <NavLink
                to="/AdminRole/PersonalInformation"
                className={({ isActive }) =>
            ...
            <li>
              <NavLink
                to="/AdminRole/ManageStudentAdmin"
                className={({ isActive }) =>
                  `${isActive ? "bg-[#E6E6E6]" : "text-gray-600"}`
                }
              >
